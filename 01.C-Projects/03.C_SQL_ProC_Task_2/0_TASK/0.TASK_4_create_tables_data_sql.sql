...
Alter table customers MODIFY external_reference varchar2(60) not null unique;
/
Alter table payments add original_payment_id varchar2(60); 
alter table payments
   add constraint fk_paym_id_orig_paym_id
...
Alter table invoices MODIFY original_invoice_id references invoices(INV_NO);
/
